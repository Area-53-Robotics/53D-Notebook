...
#show: create-entry.with(
  ...
  attendance: ("Ishika", "Makhi", "Rory", "Eric", "Samia", "Anders"),
  designed: "Ishika",
  witnessed: "Samia",
)
...
We solved this problem by creating a workflow that tests if the program compiles without errors. The workflow creates a Linux virtual machine that attempts to build the code in the ```53D_PushBack``` repository.
...
#align(center)[*53D-Push-Back-Notebook/.github/workflows/build.yml*]
...
#code-header(main: false)[53D-Push-Back-Notebook/.github/workflows/typos.yml]
